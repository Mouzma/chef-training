<powershell>
 ...
 $env:CHEF_SERVER_NAME = "chef-training" # Name of your Chef Server
 $env:CHEF_SERVER_ENDPOINT = "chef-training-ejeaq3jyklrtwuvo.us-east-2.opsworks-cm.io" # FQDN of your Chef Server
