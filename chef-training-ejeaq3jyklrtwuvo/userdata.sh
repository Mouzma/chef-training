...
CHEF_SERVER_NAME="chef-training" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="chef-training-ejeaq3jyklrtwuvo.us-east-2.opsworks-cm.io" # The FQDN of your Chef Server
